...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_batch_size', type=int, default=16, help='size of training batch')
    parser.add_argument('--num_iters', type=int, default=16, help='size of training batch')
    parser.add_argument('--valid_batch_size', type=int, default=16, help='size of validation batch')
